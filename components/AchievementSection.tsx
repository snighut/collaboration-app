  ...
  return (
    <section id={`year-section-${year}`} className="scroll-mt-24">
      <div className="flex items-baseline space-x-4 mb-8">
        <h2 className="text-7xl font-black text-gray-200 select-none">{year}</h2>
      ...
      <div className="grid grid-cols-1 gap-8">
        {achievements.length > 0 ? (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  {achievement.logoUrl && (
                    <div className="w-12 h-12 rounded-xl border border-gray-100 p-2 bg-white shadow-sm overflow-hidden flex items-center justify-center">
              ...
              <h3 className="text-3xl font-extrabold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors leading-tight">
                {achievement.title}
              </h3>
          ...
          <div className="text-gray-400 italic py-10 text-xl">
